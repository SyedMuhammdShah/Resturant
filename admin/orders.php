        ...
        <div class="col">
          <div class="card shadow">
            ...
            if (isset($_SESSION["cart_item"])) {
              ...
              $total_price = 0;
            ?>
              <form action="mult_order.php" method="POST">
                <div class="form-row" style="margin:20px 0px 10px 99px">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td name="prod_code" id="prod_code"><?php echo $item["prod_code"]; ?></td>
                        <td style="text-align:right;" name="quantity" id="quantity"><?php echo $item["quantity"]; ?></td>
                        <td style="text-align:right;" name="prod_price" id="prod_price"><?php echo "Rs. " . $item["prod_price"]; ?></td>
                        <td style="text-align:right;" name="item_price" id="item_price"><?php echo "Rs. " . number_format($item_price, 2); ?></td>
