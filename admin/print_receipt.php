                ...
                <div id="Receipt" class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <address>
                            <img src="assets/img/brand/Untitled-2.png" width="75" height="75" class="navbar-brand-img" alt="...">
                            <br>
                                <strong>Tokyo Burger</strong>
                                <br>
                                Shop No. D-36 Marhaba Galaxy
                                <br>
                                Block M North Nazimabad, KHI
                                <br>
                                +92 318 2077 123
                            </address>
                        </div>
